...
class ExecCommand(sublime_plugin.WindowCommand, ProcessListener):
    ...
    def run(
        ...
        # https://github.com/SublimeTextIssues/Core/issues/679#issuecomment-215424481
        # orig: show_panel_on_build = sublime.load_settings("Preferences.sublime-settings").get("show_panel_on_build", True)
